	...
	<form form class="layui-form" id="edit_form" isLoad="1" loadUrl="/Second/student/studentInfoShow?${param.iphone}">
	  ...
	  <div class="layui-form-item">
	   ...
	   <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="iphone" required=""  lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input"/>
	    </div>
	  </div>
	  <div class="layui-form-item">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" name="livetime" autocomplete="off" class="layui-input fsDate" dateType="datetime" />
	    </div>
	  </div>
	   ...
	   <div class="layui-form-item layui-form-text"   id="xiugai">
	     	<div class="layui-col-xs6" style="text-align: center">
						<img id="imgP" src=""  class="profile-img" width="200px" height="200px">
						 <input type="hidden" id="img" name="img" value=""/>
						<br/>
						<button type="button" class="layui-btn layui-btn-primary" id="btnUploadProfile">
							<i class="layui-icon">&#xe67c;</i>展示头像
						</button>
					</div>
	  </div>
...
$(document).ready(function(){
	...
	$.ajax({
	type: "POST",
	url: "/Second/user/showImg",
	data : {
		"iphone" : a,
	},
	success: function(result){
		$('#imgP').attr('src',result)
	}
	});
	}
	show("${param.iphone}");
