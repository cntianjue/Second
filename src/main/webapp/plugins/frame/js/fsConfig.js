...
layui.define([], function (exports) {
	...
	fsConfig["global"] = {
		...
		"loginUrl" : "/index.jsp", //登录url
		"uploadUrl" : "http://localhost:8080/Second/user/upload", //上传附件url
		"uploadHtmlUrl" : "http://localhost:8080/Second/plugins/frame/views/upload.html", //上传附件html地址，默认/plugins/frame/views/upload.html
