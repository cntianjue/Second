...
layui.define(['element',"fsConfig","fsCommon"], function(exports){
	...
	var menuConfig = {
			...
			/*	{"menuId":"2","menuName":"测试","menuIcon":"","menuHref":"","parentMenuId":0},*/
				...
				{"menuId":"111","menuName":"首页","menuIcon":"&#xe68e;","menuHref":"main.html","parentMenuId":"11"},
//				{"menuId":"datagrid","menuName":"数据表格","menuIcon":"fa-list","menuHref":"views/datagrid/index.html","parentMenuId":"11"},
				{"menuId":"datagrid2","menuName":"班级信息","menuIcon":"fa-list","menuHref":"views/datagrid2/index.jsp","parentMenuId":"11"},
//				{"menuId":"treeDatagrid","menuName":"树+表格","menuIcon":"fa-list","menuHref":"views/treeDatagrid/index.html","parentMenuId":"11"},
				{"menuId":"multiDatagrid","menuName":"学生管理","menuIcon":"fa-list","menuHref":"views/studentManage/index.jsp","parentMenuId":"11"},
				/*tab数据表格*/
	/*			{"menuId":"tabDatagrid","menuName":"宿舍信息","menuIcon":"fa-list","menuHref":"views/tabDatagrid/index.html","parentMenuId":"11"},*/
				{"menuId":"complexDatagrid","menuName":"宿舍管理","menuIcon":"fa-list","menuHref":"views/complexDatagrid/index.jsp","parentMenuId":"11"},
